...
; 0000 0046 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=In Bit1=In Bit0=In
; 0000 0047 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(8)
	OUT  0x17,R30
; 0000 0048 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=T Bit1=T Bit0=T
...
; 0000 0052 // Function: Bit7=In Bit6=In Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0053 DDRD=(0<<DDD7) | (0<<DDD6) | (1<<DDD5) | (1<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(48)
	OUT  0x11,R30
; 0000 0054 // State: Bit7=T Bit6=T Bit5=0 Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0059 // Clock value: 7.813 kHz
; 0000 005A // Mode: Fast PWM top=0xFF
; 0000 005B // OC0 output: Non-Inverted PWM
; 0000 005C // Timer Period: 32.768 ms
; 0000 005D // Output Pulse(s):
; 0000 005E // OC0 Period: 32.768 ms Width: 0 us
; 0000 005F TCCR0=(1<<WGM00) | (1<<COM01) | (0<<COM00) | (1<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(109)
	OUT  0x33,R30
...
; 0000 0065 // Clock value: 7.813 kHz
; 0000 0066 // Mode: Fast PWM top=0x00FF
; 0000 0067 // OC1A output: Non-Inverted PWM
; 0000 0068 // OC1B output: Non-Inverted PWM
; 0000 0069 // Noise Canceler: Off
; 0000 006A // Input Capture on Falling Edge
; 0000 006B // Timer Period: 32.768 ms
; 0000 006C // Output Pulse(s):
; 0000 006D // OC1A Period: 32.768 ms Width: 0 us// OC1B Period: 32.768 ms Width: 0 us
...
; 0000 0072 TCCR1A=(1<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(161)
	OUT  0x2F,R30
; 0000 0073 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (1<<CS12) | (0<<CS11) | (1<<CS10);
	LDI  R30,LOW(13)
	OUT  0x2E,R30
...
; 0000 007F // Clock value: 31.250 kHz
; 0000 0080 // Mode: CTC top=OCR2A
; 0000 0081 // OC2 output: Disconnected
; 0000 0082 // Timer Period: 0.032 ms
; 0000 0083 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0084 TCCR2=(0<<PWM2) | (0<<COM21) | (0<<COM20) | (1<<CTC2) | (1<<CS22) | (1<<CS21) | (0<<CS20);
	LDI  R30,LOW(14)
	OUT  0x25,R30
...
; 0000 0089 TIMSK=(0<<OCIE2) | (1<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(64)
	OUT  0x39,R30
; 0000 008A 
...
; 0000 009F // ADC Clock frequency: 1000.000 kHz
...
; 0000 00A4 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 00A5 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(131)
	OUT  0x6,R30
