...
; 0000 004C DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(255)
	OUT  0x14,R30
...
; 0000 0099 // ADC Auto Trigger Source: Free Running
; 0000 009A ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(64)
	OUT  0x7,R30
; 0000 009B ADCSRA=(1<<ADEN) | (0<<ADSC) | (1<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(163)
	OUT  0x6,R30
...
; 0000 00B5       lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 00B6       num = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R4,R30
; 0000 00B7       itoa(num, negin);
	ST   -Y,R5
	ST   -Y,R4
	MOVW R26,R10
	CALL _itoa
; 0000 00B8       lcd_puts(negin);
	MOVW R26,R10
	CALL _lcd_puts
; 0000 00B9       //lcd_putsf(strX);
; 0000 00BA       //lcd_putchar(strZ);
; 0000 00BB       //lcd_clear();
; 0000 00BC       lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	CALL _lcd_gotoxy
; 0000 00BD       num1 = read_adc(1);
	LDI  R26,LOW(1)
	RCALL _read_adc
	MOVW R12,R30
; 0000 00BE       itoa(num1, negin1);
	ST   -Y,R13
	ST   -Y,R12
	LDS  R26,_negin1
	LDS  R27,_negin1+1
	CALL _itoa
; 0000 00BF       lcd_puts(negin1);
	LDS  R26,_negin1
	LDS  R27,_negin1+1
	CALL _lcd_puts
; 0000 00C0       }
