...
_0x0:
	...
	.DB  0x75,0x73,0x0,0x69,0x6E,0x20,0x74,0x68
	.DB  0x65,0x20,0x75,0x6E,0x69,0x76,0x65,0x72
	.DB  0x63,0x69,0x74,0x79,0x21,0x21,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 009A        lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 009B        lcd_puts("in the univercity!!");
	__POINTW2MN _0x6,11
	RCALL _lcd_puts
; 0000 009C 
; 0000 009D       }
