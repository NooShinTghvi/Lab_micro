...
; 0000 0048 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(8)
	OUT  0x17,R30
...
; 0000 0053 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0054 DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(224)
	OUT  0x11,R30
; 0000 0055 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 005A // Clock value: 125.000 kHz
; 0000 005B // Mode: Fast PWM top=0xFF
; 0000 005C // OC0 output: Inverted PWM
; 0000 005D // Timer Period: 2.048 ms
; 0000 005E // Output Pulse(s):
; 0000 005F // OC0 Period: 2.048 ms Width: 2.048 ms
; 0000 0060 TCCR0=(1<<WGM00) | (1<<COM01) | (1<<COM00) | (1<<WGM01) | (0<<CS02) | (1<<CS01) | (1<<CS00);
	LDI  R30,LOW(123)
	OUT  0x33,R30
...
; 0000 0068 // ADC Clock frequency: 1000.000 kHz
; 0000 0069 // ADC Voltage Reference: AREF pin
; 0000 006A // ADC Auto Trigger Source: ADC Stopped
; 0000 006B ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 006C ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(131)
	OUT  0x6,R30
; 0000 006D SFIOR=(0<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 006E 
...
_0x6:
; 0000 0080       {
; 0000 0081           num = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R4,R30
; 0000 0082           itoa(num, wire);
	ST   -Y,R5
	ST   -Y,R4
	LDI  R26,LOW(_wire)
	LDI  R27,HIGH(_wire)
...
; 0000 0086           OCR0 = num;
	OUT  0x3C,R4
; 0000 0087           /*if((num > 0) && (num <340) ){
; 0000 0088             PORTD.5 = 1;
; 0000 0089             PORTD.6 = 1;
; 0000 008A             PORTD.7 = 1;
; 0000 008B           }
; 0000 008C           if ((num > 341) && (num < 680)) {
; 0000 008D              PORTD.5 = 0;
; 0000 008E              PORTD.6 = 1;
; 0000 008F              PORTD.7 = 1;
; 0000 0090           }
; 0000 0091           if ((num > 681) && (num <1024)) {
; 0000 0092              PORTD.5 = 0;
; 0000 0093              PORTD.6 = 0;
; 0000 0094              PORTD.7 = 1;
; 0000 0095           } */
