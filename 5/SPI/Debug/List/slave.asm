...
; 0000 002A // Function: Bit7=In Bit6=In Bit5=In Bit4=out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 002B DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (1<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(16)
	OUT  0x1A,R30
...
; 0000 0043 // SPI Clock Rate: 2000.000 kHz
; 0000 0044 // SPI Clock Phase: Cycle Start
; 0000 0045 // SPI Clock Polarity: Low
; 0000 0046 // SPI Data Order: MSB First
; 0000 0047 SPCR=(0<<SPIE) | (1<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (0<<SPR0);
	LDI  R30,LOW(64)
	OUT  0xD,R30
...
; 0000 004D // RS - PORTC Bit 0
; 0000 004E // RD - PORTC Bit 1
; 0000 004F // EN - PORTC Bit 2
; 0000 0050 // D4 - PORTC Bit 4
; 0000 0051 // D5 - PORTC Bit 5
; 0000 0052 // D6 - PORTC Bit 6
; 0000 0053 // D7 - PORTC Bit 7
; 0000 0054 // Characters/line: 16
; 0000 0055 lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 0056 
; 0000 0057 data_send = 0110;
	LDI  R30,LOW(72)
	MOV  R5,R30
; 0000 0058 data_get = spi(data_send);
	MOV  R26,R5
	CALL _spi
	MOV  R4,R30
; 0000 0059 while(SPSR & (1<<SPIF));
_0x3:
	SBIC 0xE,7
	RJMP _0x3
; 0000 005A itoa(data_get,buffer);
	MOV  R30,R4
	LDI  R31,0
	ST   -Y,R31
	ST   -Y,R30
...
; 0000 005B lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 005C lcd_puts(buffer);
	LDI  R26,LOW(_buffer)
	LDI  R27,HIGH(_buffer)
	RCALL _lcd_puts
; 0000 005D 
; 0000 005E if (data_get == 0){
	TST  R4
	BRNE _0x6
; 0000 005F      PORTA.4=1;
	SBI  0x1B,4
